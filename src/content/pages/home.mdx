...
engageCards:
  - isLibraryCallout: true
    ...
    cardSubheading:
      Jump into our library to get a sense of what you need to know!
  ...
  - cardTitle: Data Explorer
    cardHeading:
      '#### Want to get a sense for the current conditions of communities
      across North Texas?'
  ...
  - cardTitle: Pathways to mobility
    ...
    cardSubheading:
      Take a seat as a community leader and see how we can improve the
